#!/usr/bin/env bash
# Replace place-holders like <user>, <file>,
# <service>, <device>, <port>, <repo> as needed.
...
# Make filesystem (examples – careful!)
...
# quick test only (do not leave disabled)
sudo setenforce 0   
